...
// both directions.
//
// Skipped unless ECK_PREV_BINARY points at a build of the previous
...
const (
	...
	currentBinaryEnv = "ECK_CURRENT_BINARY"
)
...
func currentBinary(t *testing.T) string {
	...
	out := filepath.Join(t.TempDir(), "eck-current")
