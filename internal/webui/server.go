...
import (
	...
	"github.com/eck-tunnel/eck/internal/control"
...
const sessionCookie = "eck_session"
...
// Serve starts the web panel and blocks. Invoked by `eck --webui`.
func Serve() error {
	...
	// deliberately run elsewhere — in the eck-monitor service. See
