...
func TestThePanelMetricsAppearOnThePage(t *testing.T) {
	...
	for _, want := range []string{
		"eck_panel_uptime_seconds",
		`eck_panel_requests_total{outcome="ok"}`,
		`eck_panel_requests_total{outcome="refused"}`,
		`eck_panel_requests_total{outcome="failed"}`,
		"eck_panel_request_ms_mean",
		"eck_panel_request_ms_max",
		`eck_panel_jobs_total{outcome="done"}`,
	} {
