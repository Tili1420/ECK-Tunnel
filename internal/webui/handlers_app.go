...
var manifestJSON = []byte(`{
  "id": "./",
  "name": "ECK-Tunnel Panel",
  "short_name": "ECK-Tunnel",
  "description": "Live tunnel and server monitoring for ECK-Tunnel.",
  "start_url": "./",
  "scope": "./",
  "display": "standalone",
...
// iconSVG is the header's eck mark on the accent gradient, as a file.
var iconSVG = []byte(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  ...
  <g fill="none" stroke="#fff" stroke-width="8" stroke-linecap="round" stroke-linejoin="round">
    <path d="M30 100V64a34 34 0 0 1 68 0v36"/>
    <path d="M50 100V70a14 14 0 0 1 28 0v30"/>
    <path d="M22 100h84"/>
  </g>
</svg>`)
