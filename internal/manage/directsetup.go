...
import (
	...
	"github.com/eck-tunnel/eck/internal/snispoof"
...
func setupL3(side directSide) {
	...
	// GRE inside the Noise session — the framing ECK-Tunnel writes itself, not
...
func askL3Advanced(cfg *l3Spec, side directSide) {
	...
	fmt.Println()
	tui.Info("ECK-Tunnel caps the segment size of TCP crossing the tunnel, which is")
