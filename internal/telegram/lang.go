...
var fa = map[string]string{
	...
	"⬆️ ECK-Tunnel %s has been released (you are on %s).":                                          "⬆️ نسخه %s ECK-Tunnel منتشر شد (نسخه فعلی شما %s است).",
	"Update from the CLI: sudo eck → Update.":                                                      "برای به‌روزرسانی در ترمینال: sudo eck ← Update.",
