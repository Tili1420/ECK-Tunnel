// Package app holds shared constants and paths used across the eck
...
const (
	...
	// BinPath is where the eck binary is installed.
	BinPath = "/usr/local/bin/eck"
	...
	AutoRefreshMarker = "eck-auto-refresh"
	...
	WebUIService = "eck-webui.service"
	...
	MonitorService = "eck-monitor.service"
	...
	ProxyService = "eck-proxy.service"
...
// writes it.
var ReleasePublicKey = "gmO2GAoKSHtVyPlduUkOtlNmY1hq61OXJ2aVQCzqJS8="
...
func SocksPortForToken(token string) int {
	...
	sum := sha256.Sum256([]byte("eck-socks-v1:" + token))
...
func AssetName() string { return "eck_linux_" + AssetArch() + ".tar.gz" }
