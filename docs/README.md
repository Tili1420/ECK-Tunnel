...
Reference pages: what each part of ECK-Tunnel **is**, and every setting it has.
...
### Per-tunnel settings
- [Configuration reference](config-reference.md) — every key ECK-Tunnel reads, generated from the declarations.
- [Performance notes](performance-notes.md) — where the time goes, and the measurements that closed a question.
- [Design decisions](design-decisions.md) — what ECK-Tunnel deliberately does not do,
...
این پوشه **مرجع** است: هر بخش ECK-Tunnel چیست و چه تنظیماتی دارد. اگر دنبال
